...
# Dump out the merged CSVs into one CSV
$CSVData | Export-Csv -NoTypeInformation "$Scriptdir\AllHybrids.csv"

# Get path to all merged CSVs
$CSVs = @(gci $scriptdir "*hybrid*.csv")

# Set output file name
$outputfilename = "CamryHybridAllocationSpreadsheet_OneSheet.xlsx"
